...
#   define NULL_POINTER_ERROR(pointer, FAILURE_INSTRUCTION) CHECK_NULL_POINTER(pointer, Symphony::Debug::LogError, FAILURE_INSTRUCTION)
#   define NULL_POINTER_WARNING(pointer, FAILURE_INSTRUCTION) CHECK_NULL_POINTER(pointer, Symphony::Debug::LogWarning, FAILURE_INSTRUCTION)
